...
%>
	...
	<form name="user_search" method=get onsubmit="return check_all_fields(this)" action="SQL_Test.jsp">
	...
	<form name="director_search" method=get onsubmit="return check_all_fields(this)" action="SQL_Test.jsp">
...
<BR><a href="SQL_Test.jsp"> New query </a></p>
